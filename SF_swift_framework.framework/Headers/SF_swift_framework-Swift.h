...
- (BOOL)isStanza SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull XML_ELM_NAME;)
+ (NSString * _Nonnull)XML_ELM_NAME SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithSubject:(NSString * _Nonnull)subject OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Null_unspecified)toString SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isMimeCarrier SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
- (void)getRoomJIDWithChatRoom:(NSString * _Nonnull)chatRoom success:(void (^ _Nonnull)(NSArray<Rosters *> * _Nonnull))success failure:(void (^ _Nonnull)(NSString * _Nonnull))failure;
...
- (void)updateRoomSubjectWithJid:(NSString * _Nonnull)jid subject:(NSString * _Nonnull)subject;
...
/// @param userJID
/// @return
- (BOOL)sendAddChatRoomMemberRequestWithRoomJID:(JID * _Nonnull)roomJID userJID:(JID * _Nonnull)userJID SWIFT_WARN_UNUSED_RESULT;
/// Request to Remove member from chat room. This request should be given by {@link Affiliation#ADMIN} or {@link Affiliation#OWNER}
/// @param corrId
/// @param roomJID
/// @param userJID
/// @return
- (BOOL)sendRemoveChatRoomMemberRequestWithRoomJID:(JID * _Nonnull)roomJID userJID:(JID * _Nonnull)userJID SWIFT_WARN_UNUSED_RESULT;
...
/// @return true if the request was sent to server successfully otherwise
/// false
- (BOOL)sendGetChatRoomsRequest SWIFT_WARN_UNUSED_RESULT;
/// Send request to retrieve memeber of a chatroom.
/// @param roomName
/// @return true if the request was sent to server successfully otherwise
/// false
- (BOOL)sendGetChatRoomMembersRequestWithRoomJID:(JID * _Nonnull)roomJID SWIFT_WARN_UNUSED_RESULT;
